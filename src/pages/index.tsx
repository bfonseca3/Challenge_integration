...
export default function Home() {
  ...
  const filteredEnterprises = useMemo(() => enterprises?.filter((enterprise: IEnterpriseInfo) => (
  ...
  function handleLoadMore() {
    setNumOfItems((prevState: number) => prevState + 5);
  }
  ...
  return (
    <Container>
      ...
      <Wrapper>
        ...
        <MainContent>
          {filteredEnterprises?.map((enterprise: IEnterpriseInfo) => (
        ...
        {
          filteredEnterprises && filteredEnterprises?.length >= 5 && (
